...
-- Create relationship between `message` and `account` tables --
ALTER TABLE IF EXISTS public.message 
ADD CONSTRAINT fk_account_to FOREIGN KEY (message_to) 
REFERENCES public.account (account_id) MATCH SIMPLE
ON UPDATE CASCADE
ON DELETE NO ACTION,
ADD CONSTRAINT fk_account_from FOREIGN KEY (message_from)
REFERENCES public.account (account_id) MATCH SIMPLE
ON UPDATE CASCADE
ON DELETE NO ACTION;
